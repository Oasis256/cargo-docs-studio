...
<table class="footer-table">
  <tr>
    <td style="width:60%;text-align:center;vertical-align:top;padding:10px;">
      <div style="margin-bottom:15px;"><strong>For and on behalf of 4</strong></div>
...
<table class="sign">
  <tr>
    ...
    private function renderReferenceSkrStable(array $payload, array $trackingBlock, array $theme): string
    {
        ...
        $issuerTitle = sanitize_text_field((string) ($payload['issuer_title'] ?? 'ISSUING OFFICER LIMITED'));
...
<table style="width:100%;border-collapse:collapse;margin-top:8px;">
  <tr>
    <td style="width:50%;font-size:10pt;border:none;">' . esc_html($issuerName) . '<br><strong>' . esc_html($issuerTitle) . '</strong></td>
